...
test-go-units-crdb: cleanup-test-go-units-crdb
	...
	go test -count=1 -v ./pkg/rid/store/cockroach --datastore_host localhost --datastore_port 26257 --datastore_ssl_mode disable --datastore_user root --datastore_db_name rid
	go test -count=1 -v ./pkg/rid/application --datastore_host localhost --datastore_port 26257 --datastore_ssl_mode disable --datastore_user root --datastore_db_name rid
	go test -count=1 -v ./pkg/scd/store/cockroach --datastore_host localhost --datastore_port 26257 --datastore_ssl_mode disable --datastore_user root --datastore_db_name scd
