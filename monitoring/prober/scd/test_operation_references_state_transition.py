...
@for_api_versions(scd.API_0_3_5)
@default_scope(SCOPE_SC)
def test_op_accepted_v5(scd_api, scd_session):
...
@for_api_versions(scd.API_0_3_15)
@default_scope(SCOPE_SC)
def test_op_accepted_v15(scd_api, scd_session):
  # Accepted for the first time
  with open('./scd/resources/op_request_1.json', 'r') as f:
    req = json.load(f)
...
@for_api_versions(scd.API_0_3_5)
@default_scope(SCOPE_SC)
def test_op_activated_v5(scd_api, scd_session):
  # GET current op
...
@for_api_versions(scd.API_0_3_15)
@default_scope(SCOPE_SC)
def test_op_activated_v15(scd_api, scd_session):
  # GET current op
...
@for_api_versions(scd.API_0_3_5)
@default_scope(SCOPE_SC)
def test_op_accepted_bad1_v5(scd_api, scd_session):
  # GET current op
  resp = scd_session.get('/operation_references/{}'.format(OP_ID))
  assert resp.status_code == 200, resp.content
  existing_op = resp.json().get('operation_reference', None)
...
@for_api_versions(scd.API_0_3_15)
@default_scope(SCOPE_SC)
def test_op_accepted_bad1_v15(scd_api, scd_session):
  # GET current op
  resp = scd_session.get('/operational_intent_references/{}'.format(OP_ID))
  assert resp.status_code == 200, resp.content
  existing_op = resp.json().get('operational_intent_reference', None)
...
@for_api_versions(scd.API_0_3_5)
@default_scope(SCOPE_SC)
def test_op_bad_state_transition_v5(scd_api, scd_session):
  # Delete operation
...
@for_api_versions(scd.API_0_3_15)
@default_scope(SCOPE_SC)
def test_op_bad_state_transition_v15(scd_api, scd_session):
  # Delete operation
