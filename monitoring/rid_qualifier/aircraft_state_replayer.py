...
class TestHarness():
    ...
    def submit_test(self,uss_session:DSSTestSession, payload:DeliverablePayload) -> None:
        ...
        requested_flights ={"requested_flights":payload.injection_payload.requested_flights}
        
        response = uss_session.put(url =injection_path, json= requested_flights, scope = ' '.join([rid.SCOPE_RID_QUALIFIER_INJECT ]))
