...
from monitoring.uss_qualifier import create_flight_record_from_kml as frk

def test_get_interpolated_value(mocker):
    mocker.patch(
        'monitoring.uss_qualifier.create_flight_record_from_kml.get_polygons_distances_from_point',
