...
class TestTarget():
    ...
    def inject_flight(self, flight_request: FlightInjectionAttempt, dry=False) -> InjectFlightResponse:
    ...
    def delete_flight(self, flight_name: str, dry=False) -> DeleteFlightResponse:
