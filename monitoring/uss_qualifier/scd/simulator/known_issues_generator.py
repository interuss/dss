...
nominal_planning_test_if_conflict_with_flight_notification = KnownIssueFields(test_code = "nominal_planning_test", 
...
nominal_planning_with_priority_test_subject =  "Priority Operational Intent Processsing"
nominal_planning_test_with_priority_conflict_with_flight_notification = KnownIssueFields(test_code = "nominal_planning_test_with_priority", 
                                                            relevant_requirements = [], 
                                                            severity = "High", 
