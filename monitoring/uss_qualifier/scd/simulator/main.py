...
def parseArgs() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Generate test definitions using the simulator")
...
def main() -> int:
    ...
    if locale.allow_same_priority_intersections:
        raise NotImplemented("The simulator do not support intersections with same priority yet.")
