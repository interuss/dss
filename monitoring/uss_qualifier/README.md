...
- Flight states for a KML file can be generated by running [run_flight_state_locally.sh](bin/generate_rid_test_definition_from_kml.sh). run_flight_state_locally.sh expects absolute path to the input KML file and output folder as parameters.
