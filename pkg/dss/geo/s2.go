...
func Volume4DToCellIDs(v4 *dssv1.Volume4D) (s2.CellUnion, error) {
	if v4 == nil {
...
func Volume3DToCellIDs(v3 *dssv1.Volume3D) (s2.CellUnion, error) {
	if v3 == nil {
		return nil, errBadCoordSet
	}
...
func GeoPolygonToCellIDs(geopolygon *dssv1.GeoPolygon) (s2.CellUnion, error) {
	var points []s2.Point
	if geopolygon == nil {
		return nil, errBadCoordSet
	}
