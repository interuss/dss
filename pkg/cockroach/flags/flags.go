...
func init() {
	...
	flag.IntVar(&connectParameters.MaxIdleConns, "max_idle_conns", -1, "maximum number of connections in the idle connection pool, default is -1 (n<=0 is do not keep idle connection, 0 is unlimited idle connections) ")
