...
should call out to the repository layer (currently backed by cockroachdb or Yugabyte). Logic
...
The implementation of the Repository layer, connecting to a CockroachDB or Yugabyte instance.
