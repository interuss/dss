...
func (a *Server) CreateSubscription(ctx context.Context, req *restapi.CreateSubscriptionRequest,
	...
	payload, err := operations.NewPutSubscriptionPayload(restapi.CreateSubscriptionOperationID, req.Subscriptionid, dssmodels.Manager(*req.Auth.ClientID), "", req.Body, a.AllowHTTPBaseUrls)
	if err != nil {
...
func (a *Server) UpdateSubscription(ctx context.Context, req *restapi.UpdateSubscriptionRequest,
	...
	payload, err := operations.NewPutSubscriptionPayload(restapi.UpdateSubscriptionOperationID, req.Subscriptionid, dssmodels.Manager(*req.Auth.ClientID), req.Version, req.Body, a.AllowHTTPBaseUrls)
	if err != nil {
