{
  data:{
    "upto-v1.0.0-remove_isa_subs_tables.sql": importstr "rid/upto-v1.0.0-remove_isa_subs_tables.sql",
    ...
    "downfrom-v1.0.0-create_isa_subs_tables.sql": importstr "rid/downfrom-v1.0.0-create_isa_subs_tables.sql",
  },
}
