...
ACCESS_TOKEN=$(curl --silent \
    "http://localhost:8085/token?grant_type=client_credentials&scope=interuss.pool_status.write&intended_audience=localhost&issuer=localhost&sub=manual_tester" \
