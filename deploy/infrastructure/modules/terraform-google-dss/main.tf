...
module "terraform-commons-dss" {
  ...
  external_prometheus                    = var.external_prometheus
  ip_external_prometheus                 = module.terraform-google-kubernetes.ip_external_prometheus
  external_prometheus_allowed_ips_policy = module.terraform-google-kubernetes.external_prometheus_allowed_ips_policy
